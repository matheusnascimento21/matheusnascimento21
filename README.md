...
Atualmente cursando Inteligência Artificial, estou em busca de oportunidades para aplicar e expandir meus conhecimentos no desenvolvimento de aplicações modernas, unindo interfaces bem estruturadas no Frontend com o poder de soluções de Inteligência Artificial.**
